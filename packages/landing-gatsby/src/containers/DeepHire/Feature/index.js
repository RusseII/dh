    ...
    <SectionWrapper id="feature_section">
      <Container>
        <Box {...secTitleWrapper}>
          ...
          <Heading {...secHeading} content="Some of our most loved features" />
        </Box>

        <Box {...row}>
          {Data.deephireJson.FEATURES.map((item, index) => (
            <Box {...col} key={`feature-item-${index}`} className="feature_col">
              <FeatureBlock
                ...
                description={<Text content={item.description} {...featureDescription} />}
              />
            </Box>
          ))}
        </Box>
